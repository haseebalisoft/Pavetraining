/* Generated from SharePoint list training matrix template 11-07-26. */
export const MATRIX_META_EXPIRY_COLUMNS = [
  {
    "header": "CSCS Expiry",
    "code": "CSCS",
    "appKey": "cscsExpiry",
...
/** All N-code template columns. matrixField writable on SP list only when writable=true. */
export const MATRIX_CATEGORY_EXPIRY_COLUMNS = [
  {
    "header": "N001 - Ind FLT",
    "code": "N001",
    "name": "Ind FLT",
...
/** App keys that exist as Date columns on the SharePoint Training Matrix list today. */
export const WRITABLE_MATRIX_EXPIRY_APP_KEYS = [
  "n001Expiry",
  "n003Expiry",
  "n004Expiry",
  "n010Expiry",
