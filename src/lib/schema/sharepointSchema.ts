...
export const SHAREPOINT_LISTS = {
  ...
  nvqRegister: {
    ...
    labels: {
      ...
      companyName: "Company name",
      niNumber: "NI number",
      ulnNumber: "ULN number",
      nvqTitle: "NVQ title",
      boltonNvq: "Bolt-on NVQ",
      poNumber: "PO number",
      cardSchemeCategory: "Card scheme category",
      cardExtensionDateNeeded: "Card extension date needed",
      siteAddress: "Site address",
      siteContact: "Site contact name/number",
      englishUnderstandingConfirmed: "English understanding confirmed",
      tcAcknowledged: "T&C acknowledged",
